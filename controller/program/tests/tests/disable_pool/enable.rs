...
fn enable_pool_test_accs(keys: EnablePoolIxKeysOwned, pool: PoolStateV2) -> AccountMap {
...
fn enable_pool_test_correct_basic() {
    ...
    let pool = PoolStateV2FtaVals {
        ...
        u8_bools: PoolStateV2U8Bools::default().with_is_disabled(bool_to_u8(true)),
        ..Default::default()
    }
    .into_pool_state_v2();
...
fn to_inp((k, ps): (EnablePoolIxKeysOwned, PoolStateV2)) -> (Instruction, AccountMap) {
