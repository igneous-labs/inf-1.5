...
pub type DiffsFeeEntry = FeeEntryGen<Diff<[u8; 32]>, Diff<u32>, FeeEntryNanos<Diff<u32>>>;
...
pub fn assert_diffs_pricing_state(
    ...
    assert_list_changes(&entries, bef_entries, aft_entries, |diff, bef, aft| {
        ...
        diff.threshold_nanos
            .assert(&bef.threshold_nanos, &aft.threshold_nanos);
        gas_diff_zip_assert!(diff.fee_nanos, bef.fee_nanos, aft.fee_nanos);
    });
}
