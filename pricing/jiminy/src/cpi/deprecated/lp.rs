use inf1_pp_core::instructions::{
    deprecated::lp::{
        mint::{PriceLpTokensToMintIxArgs, PriceLpTokensToMintIxData},
        IxAccs,
    },
    IX_DATA_LEN,
};
...
#[inline]
pub fn cpi_price_lp_tokens_to_mint<'cpi, 'accounts, const MAX_CPI_ACCS: usize>(
    cpi: &'cpi mut Cpi<MAX_CPI_ACCS>,
    abr: &'cpi mut Abr,
    pricing_prog: AccountHandle<'accounts>,
    ix_args: PriceLpTokensToMintIxArgs,
