use inf1_ctl_core::instructions::swap::v2::exact_in::{
    SwapExactInV2IxPreAccFlags, SwapExactInV2IxPreKeysOwned, SWAP_EXACT_IN_V2_IX_PRE_IS_SIGNER,
    SWAP_EXACT_IN_V2_IX_PRE_IS_WRITER,
};
...
pub fn swap_exact_in_v2_ix_keys_owned<C: SolValCalcAccs, D: SolValCalcAccs, P: PriceExactInAccs>(
    SwapExactInIxAccs {
        ix_prefix,
        inp_calc_prog,
        inp_calc,
        ...
        pricing_prog,
        pricing,
    }: &SwapExactInIxAccs<[u8; 32], SwapExactInV2IxPreKeysOwned, C, D, P>,
) -> SwapExactInIxAccs<
    [u8; 32],
    SwapExactInV2IxPreKeysOwned,
    C::KeysOwned,
    D::KeysOwned,
    P::KeysOwned,
> {
...
/// Call [`IxAccs::seq`] on return value to create iterator
pub fn swap_exact_in_v2_ix_is_signer<
    T,
    I,
    C: SolValCalcAccs,
    D: SolValCalcAccs,
...
) -> SwapExactInIxAccs<bool, SwapExactInV2IxPreAccFlags, C::AccFlags, D::AccFlags, P::AccFlags> {
    IxAccs {
        ix_prefix: SWAP_EXACT_IN_V2_IX_PRE_IS_SIGNER,
        inp_calc_prog: false,
...
/// Call [`IxAccs::seq`] on return value to create iterator
pub fn swap_exact_in_v2_ix_is_writer<
    T,
    I,
    C: SolValCalcAccs,
    D: SolValCalcAccs,
...
>(
    ...
    IxAccs {
        ix_prefix: SWAP_EXACT_IN_V2_IX_PRE_IS_WRITER,
        inp_calc_prog: false,
